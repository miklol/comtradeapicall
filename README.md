...
- Python 3.7+
- UN Comtrade API Key (Optional for preview, required for full data)

> **Note:** You can get a free API Subscription Key from the [UN Comtrade Developer Portal](https://comtradedeveloper.un.org/product#product=free).
